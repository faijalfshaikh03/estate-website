...
const Projects = () => {
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Projects <span className='underline underline-offset-4 font-light decoration-1 under'>completed</span></h1>
        <p className='text-center mb-8 mx-auto max-w-80 text-gray-500'>Crafting Spaces, Building Legacies-Explore Our Portfolio</p>
          ...
          <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4' >
            ...
            <div className='absolute left-0 right-0 bottom-5 flex justify-center'>
              <div className='inline-block bg-white w-3/4 px-4 py-2 shadow-md'>
                <h2 className='text-xl font-semibold font-gray-800'>{project.title}</h2>
